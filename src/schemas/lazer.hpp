...
REALM_EMBEDDED_SCHEMA(BeatmapDifficulty, DrainRate, CircleSize,
                      OverallDifficulty, ApproachRate, SliderMultiplier,
                      SliderTickRate);
...
REALM_SCHEMA(Ruleset, ShortName, OnlineID, Name, InstantiationInfo,
...
REALM_SCHEMA(BeatmapMetadata, Title, TitleUnicode, Artist, ArtistUnicode,
             Author, Source, Tags, PreviewTime, AudioFile, BackgroundFile,
             UserTags);
...
REALM_SCHEMA(BeatmapSet, ID, OnlineID, DateAdded, DateSubmitted, DateRanked,
             Beatmaps, Files, Status, DeletePending, Hash, Protected);
...
REALM_SCHEMA(Beatmap, ID, DifficultyName, Ruleset, Difficulty, Metadata,
             UserSettings, BeatmapSet, OnlineID, Length, BPM, Hash, StarRating,
             MD5Hash, OnlineMD5Hash, LastLocalUpdate, LastOnlineUpdate, Status,
             Hidden, EndTimeObjectCount, TotalObjectCount, LastPlayed,
