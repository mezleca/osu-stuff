...
export const convert_lazer_to_stable = (lazer_beatmaps) => {
    ...
    for (let i = 0; i < lazer_beatmaps.length; i++) {
        ...
        const data = {
            ...
            artist_unicode: beatmap.Metadata?.ArtistUnicode || "",
            title: beatmap.Metadata?.Title || "",
            title_unicode: beatmap.Metadata?.TitleUnicode || "",
            ...
            ar: beatmap.Difficulty?.ApproachRate || 0,
            ...
            beatmapset_id: beatmap.BeatmapSet.OnlineID || -1,
            thread_id: -1,
            grade_standard: 0, 
            grade_taiko: 0, 
            grade_ctb: 0, 
